...
from utils.corepowertree import Configuration, CorePowerTree, Source, UserConfiguration, SinkSourceCfg, Library
...
class TestClass(TestCase):
    ...
    def test4_create_example_source_cfg(self):
        app_source_cfg = UserConfiguration(referenece_net_name="GND",
                                           node_to_ground="U3A1",
